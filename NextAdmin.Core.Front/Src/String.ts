...
try {
    ...
    String.prototype.extractTags = function (startDelimiter: string, endDelimiter: string) {
    ...
    String.prototype.replaceTags = function (startDelimiter: string, endDelimiter: string, replaceAction: (tagContent: string) => string): string {
        let str = this as string;
        let outputStr = '';
        let i = 0;
        for (let subStr of str.split(startDelimiter)) {
    ...
    String.prototype.removeTags = function (startDelimiter: string, endDelimiter: string): string {
        let str = this as string;
        let outputStr = '';
    ...
    String.prototype.hexColorToRGBA = function (alpha: number) {
        let hexaColor = this;
        var r = parseInt(hexaColor.slice(1, 3), 16),
            g = parseInt(hexaColor.slice(3, 5), 16),
            b = parseInt(hexaColor.slice(5, 7), 16);
    ...
    String.prototype.toDigit = function (digitCount: number) {
        var loop = digitCount;
        var zeros = "";
        while (loop) {
            zeros += "0";
    ...
    String.prototype.decodeBase64Utf8 = function (str: string): string {
    ...
    String.prototype.replaceAllRegExp = function (regExp: RegExp, replace: string): string {
        let output = this;
        while (true) {
            let org = output + '';
    ...
    String.prototype.contains = function (search: string) {
        return (<string>this).includes(search);
    }

    String.prototype.nl2br = function () {
        return NextAdmin.String.nl2br(<string>this);
    }

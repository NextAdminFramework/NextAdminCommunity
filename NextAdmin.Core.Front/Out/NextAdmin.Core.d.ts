...
declare namespace NextAdmin {
    class Url {
        ...
        removeParamter(parameter?: string): void;
    }
}
declare namespace NextAdmin {
    class UserAgent {
...
declare namespace NextAdmin.UI {
    class MaplibreMap extends Control {
        options: MaplibreMapOptions;
        map: maplibregl.Map;
        initialLocation: LatLng;
        onMapInitialized: EventHandler<MaplibreMap, maplibregl.Map>;
        constructor(options?: MaplibreMapOptions);
        initializeMap(): Promise<void>;
        addMarker(location: LatLng, options?: maplibregl.MarkerOptions): maplibregl.Marker;
    }
    interface MaplibreMapOptions extends ControlOptions {

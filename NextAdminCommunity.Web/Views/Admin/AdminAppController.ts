class AdminAppController extends NextAdmin.NavigationController {
    ...
    constructor(options?: AdminAppControllerOption) {
        super({
            defaultPage: 'login',
    ...
    public options: AdminAppControllerOption;
    ...
    public onUserLoggedIn = new NextAdmin.EventHandler<AdminAppController, NextAdmin.Models.User>();

    public onUserLoggedOut = new NextAdmin.EventHandler<AdminAppController, NextAdmin.Models.User>();
    ...
    async startApp() {
        ...
        if (user) {
            this.logUser(user as Models.AdminUser);
        }
        else {
...
interface AdminAppControllerOption extends NextAdmin.NavigationControllerOptions {
